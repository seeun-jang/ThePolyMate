...
사용자의 일상과 성장을 돕는 '초개인화 AI 에이전트'의 화면을 기획하고 구현한 정적(Static) 웹페이지입니다. 
현재는 동적인 기능없이 오직 HTML5와 CSS3만을 활용하여 화면 구조와 디자인을 정교하게 설계하는 데 집중했습니다.
...
기존 AI의 차가운 느낌 대신, 심리적 안정감을 주는 부드러운 감성을 담았습니다. 파스텔 톤 컬러와 둥근 모서리(border-radius)를 활용하여 눈이 편안한 UI를 구성했습니다. 또한 사용자의 성향에 따라 테마를 구성하여 집, 여행, 우주라는 컨셉을 잡았습니다.
...
현재는 정적인 UI/UX 설계에 집중하였으나, 추후 실제 AI 기술을 연동하여 다음 기능을 구현하는 것이 최종 목표입니다.
